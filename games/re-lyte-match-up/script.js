(function () {
  ...
  const storyBank = [
    ...
    { name: "Silas", character: "silas", answer: "hydration-plus-capsules", story: "My days on the farm start early and end late, so I need a convenient way to meet my hydration and nutrition needs. I don’t always have time to make a drink, and my sluggish thyroid could benefit from more iodine support now that I’ve switched from iodized salt. I want a simple, convenient fix while I’m working and through my day." },
    { name: "Caleb", character: "caleb", answer: "energy", story: "Between school drop-offs, work, and keeping up with the kids, my mornings can get hectic fast. By the afternoon, I’m running on fumes. I’m looking for a tasty alternative to caffeinated sodas that can support my energy so I can keep showing up for my family." },
